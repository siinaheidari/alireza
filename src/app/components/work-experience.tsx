                        ...
                        workItems.map(item => <div data-aos={"fade-right"} key={item?.date}>
                            <li className="mb-10 ms-8 flex gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="#"
                                       className="inline-flex items-center px-4 py-1 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-100 focus:text-blue-700 ">Learn
